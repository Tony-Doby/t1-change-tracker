...
export default function ScanFormView({ onSubmit, isLoading }: ScanFormViewProps) {
  ...
  return (
    <Card>
      <div className="max-w-2xl">
        <h2 className="text-[1.23rem] font-medium text-text-primary mb-4">Quét folder mới</h2>
